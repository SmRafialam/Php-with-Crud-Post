  ...
  <!--|.....................................|
        ...
        <?php
          ...
          if(isset($_POST["save"])){
            ...
            // }
              ...
              $msg = userInsert($name,$userName,$email,$pass,$phone,$status);
              echo $msg;
            }
          }
      ...
      <form method="POST">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="sname" aria-describedby="emailHelp" placeholder="Student Name" name="sname">
        ...
        <div class="mb-3">
            ...
            <input type="phone" class="form-control" id="phone" aria-describedby="emailHelp" placeholder="Phone No." name="phone">
